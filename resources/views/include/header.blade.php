    ...
    <div class="main-header-right row">
        <div class="main-header-left d-lg-none w-auto">
            <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded"
                        src="{{ asset('asset/dasbord/images/dashboard/multikart-logo.png') }}" alt=""></a></div>
        </div>
        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    {{-- <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{ asset('asset/dasbord/images/dashboard/man.png') }}"
                    alt="header-user"> --}}
                    <div class="media align-items-center"><img
                            class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded"
                            src="{{ asset('asset/upload/user') }}/{{ Auth::user()->profile_image }}" alt="header-user">
